...
clear
    ...
    while is_playing:
        ...
        if turn == 'player':
            ...
            make_move(get_board, player_letter, move)
            ...
            move = c_move(get_board, c_move)
            make_move(get_board, c_move, move)

            if is_winner(get_board, c_move):
                draw_board(get_board)
